...
describe('Service Tests', () => {
  describe('ReferralProgram Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new ReferralProgram(123, 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a ReferralProgram', async () => {
        const returnedFromService = { name: 'BBBBBB', description: 'BBBBBB', rewardAmount: 1, ...elemDefault };
      ...
      it('should partial update a ReferralProgram', async () => {
        const patchObject = { name: 'BBBBBB', ...new ReferralProgram() };
