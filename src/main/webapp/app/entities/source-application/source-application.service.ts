...
export default class SourceApplicationService {
  ...
  create(entity: ISourceApplication): Promise<ISourceApplication> {
    return new Promise<ISourceApplication>((resolve, reject) => {
      axios
  ...
  update(entity: ISourceApplication): Promise<ISourceApplication> {
    return new Promise<ISourceApplication>((resolve, reject) => {
      axios
  ...
  partialUpdate(entity: ISourceApplication): Promise<ISourceApplication> {
    return new Promise<ISourceApplication>((resolve, reject) => {
      axios
