...
import { SubscriptionType } from '@/shared/model/subscription-type.model';
...
describe('Service Tests', () => {
  describe('SubscriptionType Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a SubscriptionType', async () => {
      ...
      it('should not update a SubscriptionType', async () => {
      ...
      it('should not partial update a SubscriptionType', async () => {
      ...
      it('should not return a list of SubscriptionType', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a SubscriptionType', async () => {
      ...
      it('should not delete a SubscriptionType', async () => {
