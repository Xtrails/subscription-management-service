      ...
      <table class="table table-striped" aria-describedby="payments">
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('paymentDttm')">
              <span v-text="t$('subscriptionManagementServiceApp.payment.paymentDttm')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'paymentDttm'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('hashSum')">
              <span v-text="t$('subscriptionManagementServiceApp.payment.hashSum')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'hashSum'"></jhi-sort-indicator>
            </th>
        ...
        <tbody>
          <tr v-for="payment in payments" :key="payment.id" data-cy="entityTable">
            ...
            <td>{{ payment.paymentDttm }}</td>
            <td>{{ payment.hashSum }}</td>
            <td>
