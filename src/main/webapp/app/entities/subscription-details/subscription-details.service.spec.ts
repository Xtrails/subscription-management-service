...
import { SubscriptionDetails } from '@/shared/model/subscription-details.model';
...
describe('Service Tests', () => {
  describe('SubscriptionDetails Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new SubscriptionDetails(123, 'AAAAAAA', 'AAAAAAA', 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a SubscriptionDetails', async () => {
      ...
      it('should not create a SubscriptionDetails', async () => {
      ...
      it('should not update a SubscriptionDetails', async () => {
      ...
      it('should not partial update a SubscriptionDetails', async () => {
      ...
      it('should not return a list of SubscriptionDetails', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a SubscriptionDetails', async () => {
      ...
      it('should not delete a SubscriptionDetails', async () => {
