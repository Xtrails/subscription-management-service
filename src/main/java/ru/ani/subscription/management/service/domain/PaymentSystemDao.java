...
public class PaymentSystemDao implements Serializable {
    ...
    public PaymentSystemDao id(UUID id) {
        this.setId(id);
        return this;
    }
    ...
    public PaymentSystemDao name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PaymentSystemDao)) {
            return false;
        }
        return getId() != null && getId().equals(((PaymentSystemDao) o).getId());
    }
