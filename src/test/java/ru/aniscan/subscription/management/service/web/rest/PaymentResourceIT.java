...
import static ru.aniscan.subscription.management.service.domain.PaymentAsserts.*;
...
import ru.aniscan.subscription.management.service.repository.PaymentRepository;
...
class PaymentResourceIT {
    ...
    public static Payment createEntity() {
        return new Payment().amount(DEFAULT_AMOUNT).status(DEFAULT_STATUS).paymentDate(DEFAULT_PAYMENT_DATE);
    }
    ...
    public static Payment createUpdatedEntity() {
        return new Payment().amount(UPDATED_AMOUNT).status(UPDATED_STATUS).paymentDate(UPDATED_PAYMENT_DATE);
    }
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.amount(UPDATED_AMOUNT).status(UPDATED_STATUS).paymentDate(UPDATED_PAYMENT_DATE);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.amount(UPDATED_AMOUNT).status(UPDATED_STATUS);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.amount(UPDATED_AMOUNT).status(UPDATED_STATUS).paymentDate(UPDATED_PAYMENT_DATE);
